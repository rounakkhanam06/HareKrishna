...
const OfferSections = ({ sections, noServiceData }) => {
  ...
  return (
    <div className="container mx-auto px-4 md:px-8 lg:px-[50px] pt-0 pb-2 md:pb-4">
      {[...sections]
        ...
        .map((section) => {
          ...
          return (
            <motion.div
              ...
              className="mb-6 rounded-3xl overflow-hidden shadow-[0_12px_24px_rgba(15,23,42,0.06)] bg-white border border-slate-100/80">
              <div
