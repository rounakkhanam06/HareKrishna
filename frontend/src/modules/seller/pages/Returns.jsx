...
const Returns = () => {
    ...
    useEffect(() => {
        if (isDetailsOpen || isRejectModalOpen) {
            // Save current scroll position and lock the page
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <p className="text-xs font-bold text-slate-800 mt-1">
                                                        {ret.customer?.name || ret.address?.name || "Customer"}
                                                    </p>
                ...
                <AnimatePresence>
                    {isDetailsOpen && selectedReturn && (
                        ...
                        <motion.div
                            ...
                            className="w-full max-w-2xl relative z-10 bg-white rounded-3xl shadow-2xl flex flex-col overflow-hidden"
                        ...
                        >
                            ...
                            <div className="px-4 py-4 sm:px-6 sm:py-5 overflow-y-auto overscroll-contain flex-1 min-h-0 space-y-4" style={{ WebkitOverflowScrolling: 'touch' }}>
                                <div className="space-y-2">
                                    <p className="text-xs font-bold text-slate-600 uppercase tracking-widest">
                                        Customer
                                    </p>
                                    <p className="text-sm font-bold text-slate-900">
                                        {selectedReturn.customer?.name || selectedReturn.address?.name || "Customer"}
                                    </p>
                                    <p className="text-xs text-slate-500">
                                        {selectedReturn.customer?.phone || selectedReturn.address?.phone || ""}
                                    </p>
                                </div>
