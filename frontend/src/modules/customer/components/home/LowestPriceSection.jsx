...
const LowestPriceSection = ({ products, onSeeAll }) => {
  ...
  return (
    <div className="-mt-[40px] mb-4 md:-mt-[40px] md:mb-8">
      <div className="relative overflow-hidden bg-linear-to-br from-primary/10 via-primary/5 to-transparent pt-16 pb-2 md:pt-16 md:pb-4 border-y border-primary/10 shadow-sm md:shadow-[inset_0_-10px_40px_rgba(0,0,0,0.02)]">
          ...
          <div className="flex justify-between items-center mb-6 md:mb-10 px-1">
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-1.5 md:gap-2 mt-1.5 md:mt-3">
                <div className="h-1 w-1 md:h-2 md:w-2 bg-[#153628] rounded-full animate-pulse shadow-[0_0_8px_rgba(21,54,40,0.5)]" />
                <span className="text-[10px] md:text-xs font-bold text-[#153628] uppercase tracking-wide opacity-90">
