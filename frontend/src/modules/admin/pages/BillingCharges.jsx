                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        value={config.platformFee === 0 ? '' : config.platformFee}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <input
                                                ...
                                                placeholder="0"
                                                onKeyDown={blockNegativeKeys}
                                                value={config.riderBasePayout === 0 ? '' : config.riderBasePayout}
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <input
                                                ...
                                                placeholder="0"
                                                onKeyDown={blockNegativeKeys}
                                                value={config.deliveryPartnerRatePerKm === 0 ? '' : config.deliveryPartnerRatePerKm}
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="relative group max-w-md">
                                        ...
                                        <input
                                            ...
                                            placeholder="0"
                                            onKeyDown={blockNegativeKeys}
                                            value={returnDeliveryCommission === 0 ? '' : returnDeliveryCommission}
                                            onChange={(e) => {
                                                const cleaned = e.target.value.replace(/[^0-9.]/g, '');
                                                const val = parseFloat(cleaned);
                                                setReturnDeliveryCommission(isNaN(val) ? 0 : val);
                                            }}
