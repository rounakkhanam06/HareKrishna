...
const CategoryManagement = () => {
    ...
    const handleDelete = async () => {
        ...
        const id = getCatId(deleteTarget);
                            ...
                            <div style={{ paddingLeft: `${level * 24}px` }} className="flex items-center space-x-3">
                                ...
                                {item.image ? (
                                    <div className="h-8 w-8 rounded-lg overflow-hidden shadow-sm ring-1 ring-gray-100">
                                         <img src={applyCloudinaryTransform(item.image, "f_auto,q_auto,w_100")} alt="" className="h-full w-full object-cover" />
                                    </div>
                                ) : (
                                    <div className={cn(
                                                        ...
                                                        <div className="flex items-center gap-3">
                                                            {sub.image ? (
                                                                <div className="h-10 w-10 bg-white rounded-xl shadow-sm ring-1 ring-slate-100 overflow-hidden">
                                                                     <img src={applyCloudinaryTransform(sub.image, "f_auto,q_auto,w_100")} alt="" className="h-full w-full object-cover" />
                                                                </div>
                                                            ) : (
                        ...
                        >
                            <div className="lg:w-1/3 bg-slate-50 p-6 border-r border-slate-100 flex flex-col justify-between">
                                <div className="space-y-6">
                                    ...
                                    >
                                        {previewUrl ? (
                                             <img src={applyCloudinaryTransform(previewUrl, "f_auto,q_auto,w_300")} alt="Preview" className="w-full h-full object-cover rounded-xl" />
                                        ) : (
                                            <>
