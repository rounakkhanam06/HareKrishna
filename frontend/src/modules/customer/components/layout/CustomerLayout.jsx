...
const CustomerLayout = ({ children, showHeader: showHeaderProp, fullHeight = false, showCart: showCartProp, showBottomNav: showBottomNavProp, showFooter: showFooterProp }) => {
    ...
    const hideFooterRoutes = ['/orders', '/transactions', '/profile', '/profile/edit', '/wishlist', '/addresses', '/wallet', '/support', '/privacy', '/about', '/terms', '/checkout', '/search', '/chat', '/payment-status', '/settings'];
    ...
    const showFooter = showFooterProp !== undefined ? showFooterProp : (!hideFooterRoutes.includes(path) && !path.startsWith('/orders') && !path.startsWith('/category/orders'));

    // Condition to hide the MobileFooterMessage ("India's last minute app") on specific pages
    const hideFooterMessageRoutes = ['/profile', '/profile/edit', '/orders', '/transactions', '/wishlist', '/addresses', '/wallet', '/support', '/privacy', '/about', '/terms', '/checkout', '/search', '/chat', '/payment-status', '/settings'];
