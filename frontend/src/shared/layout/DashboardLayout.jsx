...
import { getOrderSocket, onSellerOrderNew, onSellerOrderCancelled, onReturnDropOtp } from '@/core/services/orderSocket';
...
const DashboardLayout = ({ children, navItems, title }) => {
    ...
    useEffect(() => {
        ...
        const unsubscribeSellerCancelled = onSellerOrderCancelled(getToken, () => {
            if (fetchOrdersRef.current) fetchOrdersRef.current();
        });
