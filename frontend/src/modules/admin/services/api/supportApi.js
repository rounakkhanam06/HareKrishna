...
export const adminSupportApi = {
    ...
    getAdminProductReviews: (params) =>
        axiosInstance.get('/admin/product-reviews', { params }),
    getAdminProductReviewsAnalytics: (params) =>
        axiosInstance.get('/admin/product-reviews/analytics', { params }),
    updateAdminProductReviewStatus: (id, data) =>
        axiosInstance.patch(`/admin/product-reviews/${id}`, data),
};
