...
const ActiveSellers = () => {
  ...
  const handleSuspendSeller = async () => {
    ...
    try {
      setSuspending(true);
      await adminApi.suspendSeller(sellerToSuspend.id || sellerToSuspend._id, {
      ...
      toast.error(err.response?.data?.message || err.message || "Failed to suspend seller");
    } finally {
      setSuspending(false);
    }
  };
  ...
  useEffect(() => {
    if (selectedSeller || sellerToSuspend) {
  ...
  }, [selectedSeller, sellerToSuspend]);
                  ...
                  <tr key={seller.id} className="hover:bg-slate-50/30 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          onClick={() => setSellerToSuspend(seller)}
                          className="px-4 py-2.5 bg-rose-600 text-white rounded-xl text-[10px] font-bold hover:bg-rose-700 transition-all shadow-lg flex items-center gap-2"
                        >
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">
                      {sellerToSuspend.shopName || sellerToSuspend.ownerName}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <p className="text-xs font-semibold text-slate-500 leading-relaxed">
                    Are you sure you want to suspend this seller? This will hide all their products from customers immediately, prevent them from logging in, and log out all active sessions.
                  </p>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      placeholder="e.g. Terms of service violation, high order cancellation rate..."
                      rows={3}
                ...
                <div className="mt-6 flex items-center justify-end gap-3">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-rose-600 text-white rounded-xl text-xs font-bold hover:bg-rose-700 disabled:opacity-50 transition-all flex items-center gap-2"
                  >
