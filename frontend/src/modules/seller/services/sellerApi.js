...
export const sellerApi = {
    ...
    resetPassword: (data) => axiosInstance.post('/seller/forgot-password/reset-password', data),
    // Products
    ...
    getProductReviews: (productId, params) => axiosInstance.get(`/seller/products/${productId}/reviews`, { params }),
    getProductReviewAnalytics: (productId) => axiosInstance.get(`/seller/products/${productId}/review-analytics`),
