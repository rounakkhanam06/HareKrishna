...
const Dashboard = () => {
  ...
  const normalizeOrderForModal = (order) => {
    ...
    return {
      id: order.orderId,
      customer: {
        name: order.customer?.name || order.address?.name || "Customer",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat) => (
          <Card
            ...
            className="hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer active:translate-y-0"
          >
