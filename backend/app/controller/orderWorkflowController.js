          ...
          try {
            ...
            if (phone) {
              await sendSmsIndiaHubOtp({
                phone,
                otp: result.otp,
                message: `Your return pickup OTP for order #${orderId} is ${result.otp}. Eannadata Canteen.`,
              });
            }
          } catch (smsErr) {
          ...
          try {
            ...
            if (sellerPhone) {
              await sendSmsIndiaHubOtp({
                phone: sellerPhone,
                otp: result.otp,
                message: `Return drop OTP for order #${orderId} is ${result.otp}. Eannadata Canteen.`,
              });
            }
          } catch (smsErr) {
