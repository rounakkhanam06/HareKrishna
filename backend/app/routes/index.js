...
const setupRoutes = (app) => {
    ...
    router.use("/delivery-partners", deliveryRatingsRoute);
    ...
    router.use("/admin/delivery-ratings", adminDeliveryRatingsRoute);
    ...
    router.use("/product-reviews", productReviewRoute);
