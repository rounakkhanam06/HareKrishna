  ...
  return (
    <div className={`min-h-screen pt-[215px] md:pt-[200px] ${products.length === 0 && !isLoading ? "bg-white" : "bg-[#F5F7F8]"}`}>
      ...
      {isLoading ? (
        ...
        <>
          <div ref={heroRef} className="block">
            <div className="relative w-full overflow-hidden">
              {heroConfig.banners?.items?.length ? (
                ...
                <div className="w-full h-[190px] bg-[#ecfeff] p-6 relative overflow-hidden flex items-center border border-primary/10 shadow-sm">
