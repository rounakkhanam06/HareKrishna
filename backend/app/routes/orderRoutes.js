...
import { getOrderProductReviews } from "../controller/productReviewController.js";
import {
  placeOrder,
  getMyOrders,
  getOrderDetails,
...
import { rateDeliveryPartner, getDeliveryRatingForOrder } from "../controller/deliveryRatingsController.js";
...
router.get("/:orderId/product-reviews", verifyToken, allowRoles("customer", "user", "admin"), getOrderProductReviews);
router.put("/cancel/:orderId", verifyToken, cancelOrder);
router.post("/:orderId/rate-delivery", verifyToken, allowRoles("customer"), rateDeliveryPartner);
router.get("/:orderId/delivery-rating", verifyToken, getDeliveryRatingForOrder);
