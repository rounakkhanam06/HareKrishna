...
const SellerLocations = () => {
  ...
  return (
    <div className="h-[calc(100vh-196px)] min-h-[820px] flex flex-col gap-5 animate-in fade-in duration-700">
          ...
          {mapUnlocked && (
            <button
              onClick={() => {
                ...
                toast.info("Live map locked to save API cost");
              }}
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 xl:grid-cols-[360px_minmax(0,1fr)] gap-5 min-h-[480px]">
        <Card className="border-none shadow-xl ring-1 ring-slate-100 rounded-2xl overflow-hidden flex flex-col min-h-0">
          ...
          <div className="overflow-y-auto p-3 pb-2 space-y-2" style={{ maxHeight: 'calc(100vh - 440px)', minHeight: '200px' }}>
            {loading ? (
            ...
            <div className="h-full min-h-[680px] bg-gradient-to-br from-slate-100 via-slate-50 to-white p-6 flex items-center justify-center">
              <div className="max-w-xl text-center space-y-4">
                ...
                <button
                  onClick={() => {
                    setMapUnlocked(true);
                    toast.success("Live map unlocked");
                  }}
