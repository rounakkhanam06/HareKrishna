                        ...
                        <div className="p-4 bg-slate-50/50 flex flex-col items-end gap-3 text-right">
                            ...
                            {order.pricing?.platformFee > 0 && (
                                <div className="flex items-center justify-between w-full max-w-[240px]">
                                    ...
                                    <span className="text-sm font-bold text-slate-700">₹{order.pricing.platformFee}</span>
                                </div>
                            )}
                            {order.pricing?.gst > 0 && (
                                <div className="flex items-center justify-between w-full max-w-[240px]">
                                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">GST / Tax</span>
                                    <span className="text-sm font-bold text-slate-700">₹{order.pricing.gst}</span>
                                </div>
                            )}
                            {order.pricing?.tip > 0 && (
                                <div className="flex items-center justify-between w-full max-w-[240px]">
                                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Rider Tip</span>
                                    <span className="text-sm font-bold text-slate-700">₹{order.pricing.tip}</span>
                                </div>
                            )}
                            {order.pricing?.discount > 0 && (
                                <div className="flex items-center justify-between w-full max-w-[240px]">
                                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Discount</span>
                                    <span className="text-sm font-bold text-rose-600">-₹{order.pricing.discount}</span>
                                </div>
                            )}
                            {order.pricing?.walletAmount > 0 && (
                                <div className="flex items-center justify-between w-full max-w-[240px]">
                                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Wallet Payment</span>
                                    <span className="text-sm font-bold text-rose-600">-₹{order.pricing.walletAmount}</span>
                                </div>
                            )}
                        ...
                        <div className="space-y-6 relative ml-4">
                            ...
                            <div className="flex gap-6 relative">
                                ...
                                <div className="flex-1 pb-4">
                                    ...
                                    <p className="text-[11px] font-bold text-slate-400 leading-relaxed italic">"Current delivery status is {order.status}."</p>
                                </div>
                            </div>
                        </div>
                    </Card>
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center justify-between">
                                <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2">
                                    <Truck className="h-3.5 w-3.5" /> Delivery Partner (Rider)
                                </h4>
                            ...
                            <div className="flex items-center gap-3 mt-2">
                                ...
                                <div>
                                    <h5 className="text-sm font-black text-slate-900">{order.deliveryBoy?.name || "Pending Delivery Partner Assignment"}</h5>
                            ...
                            <tr>
                                ...
                                <td width="40%" style={{ verticalAlign: "top" }}>
                                    <table width="100%" cellPadding="8" cellSpacing="0">
                                        ...
                                        {order.pricing?.platformFee > 0 && (
                                            <tr>
                                                <td align="left" style={{ fontSize: "12px", color: "#64748b", fontWeight: "700" }}>Platform Fee</td>
                                                <td align="right" style={{ fontSize: "13px", fontWeight: "800", color: "#0f172a" }}>+ ₹{order.pricing.platformFee}</td>
                                            </tr>
                                        )}
                                        {order.pricing?.gst > 0 && (
                                            <tr>
                                                <td align="left" style={{ fontSize: "12px", color: "#64748b", fontWeight: "700" }}>GST / Tax</td>
                                                <td align="right" style={{ fontSize: "13px", fontWeight: "800", color: "#0f172a" }}>+ ₹{order.pricing.gst}</td>
                                            </tr>
                                        )}
                                        {order.pricing?.tip > 0 && (
                                            <tr>
                                                <td align="left" style={{ fontSize: "12px", color: "#64748b", fontWeight: "700" }}>Rider Tip</td>
                                                <td align="right" style={{ fontSize: "13px", fontWeight: "800", color: "#0f172a" }}>+ ₹{order.pricing.tip}</td>
                                            </tr>
                                        )}
                                        {order.pricing?.discount > 0 && (
                                            <tr>
                                                <td align="left" style={{ fontSize: "12px", color: "#64748b", fontWeight: "700" }}>Discount</td>
                                                <td align="right" style={{ fontSize: "13px", fontWeight: "800", color: "#e11d48" }}>- ₹{order.pricing.discount}</td>
                                            </tr>
                                        )}
                                        {order.pricing?.walletAmount > 0 && (
                                            <tr>
                                                <td align="left" style={{ fontSize: "12px", color: "#64748b", fontWeight: "700" }}>Wallet Payment</td>
                                                <td align="right" style={{ fontSize: "13px", fontWeight: "800", color: "#e11d48" }}>- ₹{order.pricing.walletAmount}</td>
                                            </tr>
                                        )}
                                        <tr>
