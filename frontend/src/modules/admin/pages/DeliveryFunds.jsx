                            ...
                            <div className="p-5">
                                ...
                                <div className="space-y-6 pt-6 border-t border-dashed border-slate-200">
                                    ...
                                    <div className="p-6 bg-slate-50 rounded-xl space-y-4">
                                        ...
                                        <div className="flex flex-col gap-1 items-start pt-2 border-t border-slate-200">
                                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Ref. ID</p>
                                            <span 
                                                className="text-xs font-black text-slate-900 font-mono tracking-tight cursor-pointer hover:text-primary transition-colors break-all"
                                                title="Click to copy Ref. ID"
                                                onClick={() => {
                                                    navigator.clipboard.writeText(viewingTxn.referenceId);
                                                    toast.success("Reference ID copied to clipboard!");
                                                }}
                                            >
                                                {viewingTxn.referenceId}
                                            </span>
                                        </div>
                                    </div>
                                </div>
