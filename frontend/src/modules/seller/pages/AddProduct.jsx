              ...
              <div className="space-y-1.5 flex flex-col">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    const nextName = capitalizeWords(rawVal);
                    setFormData((prev) => ({
                      ...prev,
                      name: nextName,
                      sku:
                  ...
                  className="w-full px-4 py-2.5 bg-slate-100 border-none rounded-md text-sm font-semibold outline-none ring-primary/5 focus:ring-2 transition-all capitalize"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1.5 flex flex-col">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const rawVal = e.target.value;
                      const nextBrand = capitalizeWords(rawVal);
                      setFormData((prev) => ({ ...prev, brand: nextBrand }));
                    }}
                    className="w-full px-4 py-2.5 bg-slate-100 border-none rounded-md text-sm font-semibold outline-none ring-primary/5 focus:ring-2 transition-all capitalize"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-1.5 flex flex-col">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 bg-slate-100 border-none rounded-md text-sm font-semibold outline-none ring-primary/5 focus:ring-2 transition-all text-slate-700 cursor-pointer"
                  >
                    ...
                    <div className="col-span-6 md:col-span-2 space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (val !== '' && (Number(val) < 0 || val.includes('-'))) return;
