...
export function buildHeaderGradient(baseHeaderColor) {
  if (!baseHeaderColor || baseHeaderColor === "var(--primary)" || baseHeaderColor === "#1e4836" || baseHeaderColor === "#1b4332") {
    return "linear-gradient(to bottom, #143527 0%, #1e4836 54%, #285e47 100%)";
  }
  return `linear-gradient(to bottom, ${shiftHex(baseHeaderColor, -18)} 0%, ${shiftHex(baseHeaderColor, 20)} 54%, ${shiftHex(baseHeaderColor, 165)} 100%)`;
}
